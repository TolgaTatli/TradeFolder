...
class PriceController {
  ...
  Future<List<double>> getMinOneDay(String ticker) async {
    var yfin = YahooFin();
  ...
  Future<List<double>> getMinOneMonth(String ticker) async {
    var yfin = YahooFin();
  ...
  Future<List<double>> getMinOneYear(String ticker) async {
    var yfin = YahooFin();
  ...
  Future<List<double>> getMaxOneDay(String ticker) async {
    var yfin = YahooFin();
  ...
  Future<List<double>> getMaxOneMonth(String ticker) async {
    var yfin = YahooFin();
  ...
  Future<List<double>> getMaxOneYear(String ticker) async {
    var yfin = YahooFin();
